  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#050510] overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-[#f87171]/20 blur-[120px] animate-float" />
        ...
        <div className="mb-10 text-center animate-fade-in-up">
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              <span className="text-white">Bug Tracker </span>
              <span className="bg-gradient-to-r from-[#f87171] via-[#fbbf24] to-[#f87171] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                on the Blockchain
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            Report bugs, track issues, and close tickets — immutably on Stellar.
          </p>
