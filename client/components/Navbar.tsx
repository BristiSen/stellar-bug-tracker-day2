    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#f87171] to-[#fbbf24] shadow-[0_0_20px_rgba(248,113,113,0.3)]">
