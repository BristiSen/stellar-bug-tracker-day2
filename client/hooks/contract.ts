...
// ============================================================
// Bug Tracker — Contract Methods
// ============================================================

/**
 * Create a new bug report.
 * Calls: create_bug(id: Symbol, reporter: Address, description: String)
 */
...
/**
 * Close a bug report.
 * Calls: close_bug(id: Symbol)
 */
export async function closeBug(caller: string, id: string) {
  return callContract(
    "close_bug",
    [toScValSymbol(id)],
    caller,
...
/**
 * Get bug details (read-only).
 * Calls: get_bug(id: Symbol) -> Bug
 * Returns: { reporter: string, description: string, status: string }
 */
export async function getBug(id: string, caller?: string) {
  return readContract(
    "get_bug",
    [toScValSymbol(id)],
    caller
...
/**
 * List all bug IDs (read-only).
 * Calls: list_bugs() -> Vec<Symbol>
 * Returns: Array of bug ID strings
 */
export async function listBugs(caller?: string) {
  return readContract(
    "list_bugs",
    [],
    caller
